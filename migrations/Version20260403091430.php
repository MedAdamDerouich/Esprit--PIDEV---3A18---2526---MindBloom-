...
final class Version20260403091430 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE users (id INT AUTO_INCREMENT NOT NULL, full_name VARCHAR(255) NOT NULL, email VARCHAR(100) NOT NULL, username VARCHAR(50) NOT NULL, role ENUM(\'PATIENT\',\'PSYCHOLOGUE\',\'ADMIN\') DEFAULT \'PATIENT\', password VARCHAR(255) NOT NULL, phone VARCHAR(20) DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, date_of_birth DATE DEFAULT NULL, profile_image VARCHAR(255) DEFAULT NULL, status ENUM(\'ACTIVE\',\'INACTIVE\',\'SUSPENDED\') DEFAULT \'ACTIVE\', is_email_valid TINYINT(1) DEFAULT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_1483A5E9E7927C74 (email), UNIQUE INDEX UNIQ_1483A5E9F85E0677 (username), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
